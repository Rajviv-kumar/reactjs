...
const App = () => {
  return (
    <div className='parent'>
      ...
      {
        jobOpenings.map((data, idx)=> 
          <div key={idx}>
        <Card logo={data.brandLogo} company={data.logo} date={data.datePosted} post={data.post} tag1={data.tag1} tag2={data.tag2} pay={data.pay} location={data.location}/>
        </div>
      )
      }
